...
int main(int argc, char* argv[]) {
    ...
    constexpr char socketClosedMessage[] = "{\"type\":\"message\",\"action\":\"connection\",\"message\":\"closed\"}";
    constexpr char socketOpenMessage[] = "{\"type\":\"message\",\"action\":\"connection\",\"message\":\"opened\"}";
